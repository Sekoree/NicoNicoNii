...
namespace NicoNicoNii.Entities.JSON.Video
{
    ...
    public class SessionCreateHLS
    {
        public SessionCreateHLS(WatchPageData watchPage, string[] audioQuality, string[] videoQuality, bool loggedIn)
        {
            ...
            this.Session.Protocol.Parameters.HttpParameters.Parameters.HlsParameters.UseWellKnownPort =
                watchPage.Media.Delivery.Movie.Session.Urls[0].IsWellKnownPort == true ? "yes" : "no";

            this.Session.Protocol.Parameters.HttpParameters.Parameters.HlsParameters.UseSsl =
                watchPage.Media.Delivery.Movie.Session.Urls[0].IsSsl == true ? "yes" : "no";

            this.Session.Protocol.Parameters.HttpParameters.Parameters.HlsParameters.TransferPreset =
                "";

            this.Session.Protocol.Parameters.HttpParameters.Parameters.HlsParameters.SegmentDuration =
                6000;
